...
| MSK **`kafka.m7g.large`** × 3 broker | ~$0.178/hr/broker (**list price ước lượng**, Pricing API không trả) | **~390** |
...
| **TỔNG** | | **≈ $467/mo ≈ $107.5/tuần** |

Chi hiện tại ước ~$100/tuần → **tổng ≈ $208/tuần so với trần $300/tuần** → còn ~$92/tuần dư địa. ✅ Vẫn
trong ngân sách, nhưng **sát hơn nhiều** so với ước tính t3.small ($147/tuần) — MSK là khoản đội nhiều nhất.

**⚠️ Giá m7g.large là ước lượng list-price** (AWS Pricing API không trả sản phẩm MSK broker cho query
đã thử) — **phải xác nhận bằng AWS Budgets/Cost Explorer sau vài ngày**. Có thể lệch ±10-15%.

**Phương án 2 broker** (RF=2/min.insync=1, 2 AZ): MSK ~$262/mo → tổng **~$335/mo ≈ $77/tuần**, rẻ hơn
~$130/mo. Đã cân nhắc và loại — xem §Đánh đổi (order data cần RF=3). Nếu áp lực cost tăng, đây là đòn bẩy.
...
- [x] Cost (cập nhật 18/07 sau apply) — **≈$467/mo ≈ $107.5/tuần** (MSK đổi t3.small→m7g.large vì 3.9.x loại t3.small; giá m7g.large ước lượng — cần Budgets xác nhận)
