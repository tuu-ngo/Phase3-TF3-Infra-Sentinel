...
| --- | ---: | ---: | --- |
| PM-92 Pod Security | 3/4 | 75% | 8 time-bounded runtime exceptions still need owner remediation or mentor approval. |
...
- Track the 8 current exceptions in `docs/evidence/mandate-05/exception-register.yaml`
