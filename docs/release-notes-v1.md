...
Tuy nhiên, cần lưu ý một số dependency bên ngoài vẫn sử dụng tag (ví dụ: PostgreSQL dùng tag `17.6`, OpenSearch dùng tag `2.19.0`) và có thể cập nhật bản patch ngầm định.
...
| **flagd-ui** | 58b13f2-flagd-ui | `sha256:d1a892b1a8f9024f0c4391e13fa093c3c1caea9df7643ccbe8c5c7cf1b01c107` (Rollout Status: true) |
...
> *Tất cả images trên được quét lỗ hổng tự động bởi Trivy. CI/CD Gate sẽ chặn release nếu phát hiện lỗi HIGH/CRITICAL vượt ngưỡng thông qua việc parse JSON report của Trivy tại thời điểm build.*
...
| **Grafana** | docker.io/grafana/grafana | `11.5.0` | `sha256:0f86bada30d65ef9d0183b90c1e2682ac92d53d95da8bed322b984ea78a4a73a` | Hàng quý |
| **Jaeger** | docker.io/jaegertracing/jaeger | `1.65.0` | `sha256:6266573208d665ce5c17483bce0a75d0806480d92c84766d288d0aee885ce708` | Hàng quý |
| **OpenSearch** | docker.io/opensearchproject/opensearch | `2.19.0` | `sha256:b5dd1512af2a99748c942cfbbd7f32162623336b210667d0fc6333c6321f171d` | Hàng quý |
| **Prometheus** | quay.io/prometheus/prometheus | `v3.1.0` | `sha256:c0b857aead0d5793aa566adb8f49a9983d6f6031652098759d521a330cfa050f` | Hàng quý |
| **OTel Collector** | docker.io/otel/opentelemetry-collector-contrib | `0.118.0` | `sha256:d57bfe8eee2378f31cb1193239fbcac521d54a5a071fca2bfc106916a32b892d` | Hàng quý |
| **Valkey** | docker.io/valkey/valkey | `8.0` | `sha256:c106a0c03bcb23cbdf9febe693114cb7800646b11ca8b303aee7409de005faa8` | Hàng tháng (Mới thay thế) |
...
3. Nếu Argo Rollout tiến hành Rollback các app nội bộ, quá trình không phụ thuộc vào tag, mà luôn tìm lại chính xác digest của bản release trước.
