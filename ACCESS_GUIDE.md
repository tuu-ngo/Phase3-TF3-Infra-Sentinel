...
```
kubectl -n techx-tf3 port-forward svc/product-catalog 3550:8080
kubectl -n techx-tf3 port-forward svc/cart 7070:8080
kubectl -n techx-tf3 port-forward svc/product-reviews 3551:3551
kubectl -n techx-tf3 port-forward svc/recommendation 8080:8080
kubectl -n techx-tf3 port-forward svc/currency 7001:8080
kubectl -n techx-tf3 port-forward svc/shipping 50051:8080
```